...
import circuloStore from 'lib/frontend/stores/circulo-store/circulo-store'
...
export default class SignUp extends Component {
  constructor (props) {
    ...
    this.saveCirculo = this.saveCirculo.bind(this)
  ...
  componentWillMount () {
    ...
    circuloStore.findAll({})
      .then((circulos) => {
        this.setState({circulos: circulos})
      })
      .catch((err) => {
  ...
  saveCirculo (e) {    
    this.setState({ circuloSelected: e.target.value });  
  }
          ...
          (
            <div id='signup-form'>
              ...
              <FormAsync
                ...
                <div className='form-group'>
                  <label htmlFor=''>Movimiento al que perteneces</label>
                  <select className='form-control' name='circulo' value={this.state.circuloSelected} onChange={this.saveCirculo}>
                    <option value="">No pertenezco al movimiento</option>
                    { this.state.circulos.map(c => <option value={c.id}>{c.name}</option>) }
                  </select>
                </div>
                <div className='form-group'>
                ...
                <div className='form-group aviso-privacidad'>
                  He leído y conocido <Link to='/ayuda/privacidad'>la política de tratamiento de datos personales</Link> y otorgo mi autorización para el tratamiento de mis datos
