              ...
              <FormAsync
                ...
                <div className='form-group aviso-privacidad'>
                  <input
                    ...
                    type='checkbox' />
                  He leído y conocido <Link to='/ayuda/aviso-privacidad'>la política de tratamiento de datos personales</Link> y otorgo mi autorización para el tratamiento de mis datos
                </div>
                <div className='form-group'>
                  <button
                    ref='submitBtn'
