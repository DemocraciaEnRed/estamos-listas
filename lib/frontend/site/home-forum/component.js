...
export default class HomeForum extends Component {
    ...
    forumStore
      ...
      .then(([forum, [topics, pagination]]) => {
        ...
        topics = topics.sort((a, b) => {
          ...
          if (a.closingAt) return 1;
          if (b.closingAt) return -1;
  ...
  render() {
    ...
    const isClosed =
      forum.extra.closingAt && new Date(forum.extra.closingAt) < new Date();

    const tipoConsulta =
      (forum.extra.contentType === "llamado" && "convocatoria") || "consulta";
    ...
    return (
      <div className="ext-forum-home">
          ...
          <div className="jumbotron_body">
            <div className="container">
              ...
              {(forum.extra.contentType === "ejes" ||
                forum.extra.contentType === undefined) && (
                <a className="btn btn-primary" onClick={this.handleScroll}>
            ...
            <div className="row">
              <div className="col-md-8 offset-md-2">
                <div className="consulta-cerrada">
                  ...
                  <p>
                    La {tipoConsulta} ya no está abierta a votaciones o aportes.
                  </p>
                </div>
              </div>
            </div>
        ...
        {forum.extra && forum.extra.richSummary ? (
          ...
          <div className="container summary-container">{forum.summary}</div>
        )}
        {!isClosed && forum.extra.contentType === "llamado" && (
          <div className="container cargar-propuesta" id="anchor">
            <a className="btn btn-primary" onClick={this.handleCargarPropuesta}>
              Sube tu propuesta
            </a>
          </div>
        )}
        ...
        <div className="container topics-container">
          {this.state.topics.length > 0 &&
            (forum.extra.contentType === "ejes" ||
              forum.extra.contentType === undefined) && (
              <h5 id="anchor">{`${this.state.topics.length} ${
          ...
          {this.state.topics.length > 0 &&
            forum.extra.contentType === "llamado" && (
              ...
              >
                Hay {this.state.topics.length} propuestas en esta convocatoria
              </h5>
            )}
