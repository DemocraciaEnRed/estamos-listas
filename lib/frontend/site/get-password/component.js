        ...
        <div id='forgot-form'>
          ...
          <FormAsync
            ...
            <div className='form-group aviso-privacidad'>
              Al reestablecer la contraseña manifiesta que ha leído y conocido <Link to='/ayuda/aviso-privacidad'>la política de tratamiento de datos personales</Link> y otorga su autorización para el tratamiento de sus datos
            </div>
            <div className='form-group'>
              <button
