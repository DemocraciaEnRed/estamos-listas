      ...
      <div className='ext-site-home-multiforum'>
        ...
        */}
        <div className='lead-paragraph'>
          <p>
            La plataforma <span className="bold">Estamos listas para cuidar a Medellín</span> es un canal de diálogo y colaboración  propuesto por Estamos Listas, para la construcción de iniciativas del cuidado de la vida, políticas redistributivas y aporte a la gobernanza
          </p>
          <p className='bold'>
