...
class HomeMultiForum extends Component {
  ...
  render() {
    ...
    const { showMore, activeFilter, forums } = this.state;
    ...
    return (
      <div className="ext-site-home-multiforum">
        ...
        >
          <div className="jumbotron_body">
            <div className="container">
              <img src={config.logoCentralHome} alt="Logo" width="270px" />
              <p className="lead highlight">{config.bajadaPlataforma}</p>
              <button
        ...
        <div className="lead-paragraph">
          <p>
            La plataforma{" "}
            <span className="bold">Estamos listas para cuidar a Medellín</span>{" "}
            La plataforma Estamos listas para cuidar a Medellín es un canal de
            diálogo y colaboración propuesto por Estamos Listas, para la
            construcción de iniciativas del cuidado de la vida, políticas
            redistributivas y aporte a la gobernanza
          </p>
          <p className="bold">
            Seguí estos pasos para participar y debatir de forma efectiva y
            colaborativa
          </p>
        </div>
        ...
        <div className="container forums-list" id="consultas">
          ...
          <div className="filter-container content-center">
            <div
              className="btn-group btn-group-sm dropdown-element"
              role="group"
              aria-label="Filtros"
            >
              <button
                className={`btn dropbtn ${
                  activeFilter === "byDate" ? "btn-active" : "btn-secondary"
                }`}
              ...
              <ul className="dropdown-content">
                <li
                  className={`btn btn-item-dropdown ${
                    activeFilter === "byDate" ? "btn-active" : "btn-secondary"
                  }`}
                  onClick={this.handleClick.bind(this, "byDate")}
                >
                ...
                <li
                  className={`btn btn-item-dropdown ${
                    activeFilter === "byClosed" ? "btn-active" : "btn-secondary"
                  }`}
          ...
          {!forums.length && (
            <h3 className="no-result content-center">No hay resultados</h3>
          )}
          ...
          {!!forums.length && showMore && (
            <div className="row content-center">
              <button
                className="btn btn-active show-more"
